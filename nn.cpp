...
int main(int argc, const char * argv[]) {
    ...
    for (unsigned i = 0; i < 10000; ++i) {
        ...
        if(i==9999)
		{
			ofstream output1 (DATAFOLDER + "/w1.txt");
            ofstream output2 (DATAFOLDER + "/w2.txt");
            ofstream output3 (DATAFOLDER + "/w3.txt");
			if(output1 && output2 && output3)
			{	
				for(unsigned i1=0; i1<784; i1++){
                    vector<double> temp1;
                    for(unsigned i2=0; i2<128; i2++){
                        temp1.push_back(W1[i1+i2]);
                    }
                    w1_s.push_back(temp1);
                }
				for(unsigned i1=0; i1<128; i1++){
                    vector<double> temp2;
                    for(unsigned i2=0; i2<64; i2++){
                        temp2.push_back(W2[i1+i2]);
                    }
                    w2_s.push_back(temp2);
                }
                for(unsigned i1=0; i1<64; i1++){
                    vector<double> temp3;
                    for(unsigned i2=0; i2<10; i2++){
                        temp3.push_back(W3[i1+i2]);
                    }
                    w3_s.push_back(temp3);
                }

                unsigned size1 = static_cast<int>(w1_s.size());
                unsigned size2 = static_cast<int>(w1_s[0].size());
                ...
                unsigned size3 = static_cast<int>(w2_s.size());
                unsigned size4 = static_cast<int>(w2_s[0].size());
                ...
                unsigned size5 = static_cast<int>(w3_s.size());
                unsigned size6 = static_cast<int>(w3_s[0].size());
                for (unsigned i2 = 0; i2 < size6; ++i2) {
                    for (unsigned i1 = 0; i1 < size5; ++i1) {
                        output3 << w3_s[i1][i2] << "\t";
                    }
                    output3.seekp(-1 ,ios::cur);
                    output3 << "\n";
                }
